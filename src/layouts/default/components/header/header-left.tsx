...
const HeaderLeft = () => {
  return (
    <ul className={classes.primaryNavCoreNavigation}>
      <li className={classes.primaryNavCoreNavigationItem}>
        <Link className={classes.primaryNavCoreNavigationLink} href="/">
          <div className={classes.primaryNavLogoWrap}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 152.5 28.2"
              aria-labelledby="IconBase-title-6b47c3b5-1ce4-4232-94de-6bdfec631863 IconBase-description-6b47c3b5-1ce4-4232-94de-6bdfec631863"
              role="graphics-symbol img"
              width="100%"
              height="100%"
              className={classes.primaryNavFull}
              aria-hidden="true"
            >
              <title id="IconBase-title-6b47c3b5-1ce4-4232-94de-6bdfec631863">
                Behance
              </title>
              <desc id="IconBase-description-6b47c3b5-1ce4-4232-94de-6bdfec631863" />
              <g>
                {/*[*/}
            ...
            <svg
              ...
              aria-labelledby="IconBase-title-b257ab79-6e50-4123-91ff-2669ee84c2ab IconBase-description-b257ab79-6e50-4123-91ff-2669ee84c2ab"
              role="graphics-symbol img"
              width="100%"
              height="100%"
              className={classes.primaryNavTruncated}
              aria-hidden="true"
            >
              <title id="IconBase-title-b257ab79-6e50-4123-91ff-2669ee84c2ab">
                Behance
              </title>
              <desc id="IconBase-description-b257ab79-6e50-4123-91ff-2669ee84c2ab" />
              <g>
                {/*[*/}
      ...
      {/*[*/}
      {[
        { id: 1, slug: "/?tracking_source=nav20", text: "For You" },
        {
          id: 2,
          slug: "/galleries?tracking_source=nav20",
          text: "Discover",
        },
      ].map((navItem) => (
        <li key={navItem.id} className={classes.primaryNavCoreNavigationItem}>
          <Link
            className={classes.primaryNavCoreNavigationLink}
            href={navItem.slug}
          >
            <span className={classes.primaryNavCoreNavigationLabel}>
              {navItem.text}
            </span>
          </Link>
        </li>
