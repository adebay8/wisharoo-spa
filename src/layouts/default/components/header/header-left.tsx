    ...
    <ul className={classes.primaryNavCoreNavigation}>
      ...
      {[
        ...
        <li
          key={navItem.id}
          className={clx(
            classes.primaryNavCoreNavigationItem,
            classes.primaryNavCoreNavigationText
          )}
        >
          <Link
            className={clx(classes.primaryNavCoreNavigationLink, {
              [classes.active]: pathname === navItem.slug,
            })}
            href={navItem.slug}
          >
